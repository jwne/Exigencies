...
public enum ConfigVal {
	...
	EXIGENCIES_LOGGER_CHAT_ENABLED("EXIGENCIES_LOGGER.CHAT_ENABLED", true, DataType.BOOLEAN),
	EXIGENCIES_LOGGER_COMMANDS_ENABLED("EXIGENCIES_LOGGER.COMMANDS_ENABLED", true, DataType.BOOLEAN),
	EXIGENCIES_LOGGER_MESSAGES_ENABLED("EXIGENCIES_LOGGER.MESSAGES_ENABLED", true, DataType.BOOLEAN),
	
	TIPS_DELAY("EXIGENCIES_TIPS.DELAY", 60, DataType.INTEGER),
	TIPS_ENABLED("EXIGENCIES_TIPS.ENABLED", false, DataType.BOOLEAN),
	@SuppressWarnings("serial")
	TIPS_MESSAGES("EXIGENCIES_TIPS.MESSAGES", new ArrayList<String>()
			{
		{
			add("&e&lexample_tip");
		}
