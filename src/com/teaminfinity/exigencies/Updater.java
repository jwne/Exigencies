...
public class Updater {
	...
	private static final String LINK = "exigencies";
	...
	public Updater(Plugin plugin, String slug, File file, UpdateType type, boolean announce)
	{
		...
		{
			// Invalid slug
			plugin.getLogger().warning("Twyzl has misconfigured their Auto Update system");
			plugin.getLogger().warning("The project slug given ('" + slug + "') is invalid. Please nag Twyzl about this.");
