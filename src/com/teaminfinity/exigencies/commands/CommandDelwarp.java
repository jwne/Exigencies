...
public class CommandDelwarp extends ExigenciesCommand implements CommandExecutor {

	public CommandDelwarp() {
		super("Delwarp", Cmd.COMMAND_DELWARP);
	}
	...
	public boolean onCommand(CommandSender sender, org.bukkit.command.Command cmd, String commandLabel, String[] args) 
	{
		...
		try
		{
			...
			sender.sendMessage(MessageAPI.getReformat(MessageVal.COMMAND_DELWARP_SUCCESS_SELF, args[0]));
		}
