...
public class CommandAbuse extends ExigenciesCommand implements CommandExecutor {

	public CommandAbuse() {
		super("Abuse", Cmd.COMMAND_ABUSE);
	}
	...
	public boolean onCommand(CommandSender sender, org.bukkit.command.Command cmd, String commandLabel, String[] args) 
	{
		...
		GUIHandler.getAbuse().show(player, target);
		player.sendMessage(MessageAPI.getReformat(MessageVal.COMMAND_ABUSE_SUCCESS_SELF, PlayerAPI.getName(target)));
